        ...
        <div class="container">
            ...
            @csrf
                <div class="form-group">
                    ...
                    {{--  Bagian form field tiap value akan mengisi data sebelumnya yang ada di basis data  --}}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {{--  Bagian ini menampilkan gambar yang tersimpan di basis data sebelumnya dengan maksimal lebar=150px  --}}
                </div>
